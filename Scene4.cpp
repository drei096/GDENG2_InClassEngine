...
void Scene4::loadObjects()
{
	...
	int randomNumber = 0;
	Vector3D randomPos = Vector3D(MathUtils::randomFloat(-30.0f, 30.0f), MathUtils::randomFloat(-30.0f, 30.0f), MathUtils::randomFloat(-30.0f, 30.0f));
	...
	randomPos = Vector3D(MathUtils::randomFloat(-30.0f, 30.0f), MathUtils::randomFloat(-30.0f, 30.0f), MathUtils::randomFloat(-30.0f, 30.0f));
	randomNumber = rand() % this->posList.size();
