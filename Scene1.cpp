...
void Scene1::loadObjects()
{
	...
	int randomNumber = 0;
	Vector3D randomPos = Vector3D(MathUtils::randomFloat(-15.0f, 15.0f), MathUtils::randomFloat(-15.0f, 15.0f), MathUtils::randomFloat(-15.0f, 15.0f));
	...
	randomPos = Vector3D(MathUtils::randomFloat(-15.0f, 15.0f), MathUtils::randomFloat(-15.0f, 15.0f), MathUtils::randomFloat(-15.0f, 15.0f));
	randomNumber = rand() % this->posList.size();
