...
void Scene3::loadObjects()
{
	...
	int randomNumber = 0;
	Vector3D randomPos = Vector3D(MathUtils::randomFloat(-25.0f, 25.0f), MathUtils::randomFloat(-25.0f, 25.0f), MathUtils::randomFloat(-25.0f, 25.0f));
	...
	randomPos = Vector3D(MathUtils::randomFloat(-25.0f, 25.0f), MathUtils::randomFloat(-25.0f, 25.0f), MathUtils::randomFloat(-25.0f, 25.0f));
	randomNumber = rand() % this->posList.size();
